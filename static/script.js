...
//var color = d3.scale.linear().range(["#009688", "#4db6ac"]);
var color = d3.scale.linear().range(["#4db6ac", "#009688"]);

var CriticGraph = function(data, cid, arg2) {
    var arg1 = arg1;
    var arg2 = arg2;
...
d3.csv("/carpedm20/critic/static/movie.csv", function(error, data) {
    ...
    MovieGraph(data, 'nu', 'nc');
    MovieGraph(data, 'cu', 'cc');
    MovieGraph(data, 'iu', 'ic');
    MovieGraph(data, 'nc', 'ic');
});
